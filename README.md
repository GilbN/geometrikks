...
a Heatmap or Countries mode, the latter a country choropleth colored by
request volume. With several sources, filter the map by source hostname and
watch live routes fly to each site's own home beacon (see
