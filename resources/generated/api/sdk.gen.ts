 ...
 * Stats
 */
export const statsStats = <ThrowOnError extends boolean = false>(
  options?: Options<StatsStatsData, ThrowOnError>,
) =>
  (options?.client ?? client).get<StatsStatsResponses, unknown, ThrowOnError>({
    url: "/stats",
    ...options,
  });
